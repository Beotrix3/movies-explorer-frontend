...
function Movies({ moviesCollection, searchSavedMovies, searchMovies, isLoadingMovies, savedMovies, movieDeleteFromSavedMovies, movieSaveInStore, foundError, serverError }) {
